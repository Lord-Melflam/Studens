...
export const rycStrings: Bundle = {
  fr: {
    ...
    "ryc.tab.mine": "Mes avis",
    "ryc.mine.back": "retour aux cours",
    "ryc.mine.back.list": "retour à mes avis",
    "ryc.mine.title": "Mes avis",
    "ryc.mine.anonymous": "Ce que vous avez publié anonymement n'est pas ici, et ne peut pas y être : rien ne relie ces avis à un compte, dans un sens comme dans l'autre.",
    "ryc.mine.none": "Vous n'avez encore rien publié sous votre nom.",
    "ryc.mine.published": "publié le {date}",
    "ryc.mine.edited": "modifié le {date}",
    "ryc.mine.held": "retiré de la fiche par la modération",
    "ryc.mine.more": "Voir {n} avis de plus",
    "ryc.mine.edit": "Modifier",
    "ryc.mine.editing": "Modifier votre avis sur {course}",
    "ryc.mine.saving": "Enregistrement…",
    "ryc.mine.err.failed": "La modification n'a pas pu être enregistrée.",
    "ryc.tab.browse.hint": "Vous savez dans quel programme vous êtes : parcourez sa liste de cours.",
    "ryc.tab.search.hint": "Vous savez quel cours vous cherchez : trouvez-le par son code ou son intitulé, dans tous vos catalogues.",
    "ryc.search.start": "Tapez un code, ou un mot de l'intitulé. Par exemple :",
    ...
    "ryc.filter.any": "{n} au choix",
    "ryc.filter.narrow": "filtrer la liste",
    "ryc.filter.noOption": "Rien ne correspond.",
    "ryc.scope.all": "Toutes les universités",
    "ryc.scope.change": "modifier",
    "ryc.scope.done": "terminé",
    "ryc.scope.hint": "Ce que vous gardez ici est ce que vous voyez, au prochain passage aussi.",
    ...
    "ryc.browse.more": "Voir {n} programmes de plus",
    "ryc.filter.show": "Filtrer",
    "ryc.filter.show.active": "Filtres appliqués",
    "ryc.filter.count": "{shown} cours sur {total}",
    "ryc.filter.count.window": "{shown} cours affichés, sur {total} trouvés",
    "ryc.filter.more": "Voir {n} cours de plus",
    ...
    "ryc.course.objectives": "Acquis d'apprentissage",
    "ryc.course.prerequisites": "Prérequis",
    "ryc.course.teachingMethods": "Méthodes d'enseignement",
    "ryc.course.bibliography": "Bibliographie",
    "ryc.course.noOfficialPage": "Pas de page officielle connue.",
    "ryc.course.sourceLanguage": "Fiche publiée en français par {name}.",
    ...
    "ryc.fork.named.4": "Vous pourrez le modifier, et le retrouver dans « Mes avis ».",
    ...
    "ryc.fork.note":
      "La modification ne concernera jamais un avis anonyme : personne, nous y compris, ne peut retrouver lequel est le vôtre. La suppression sur demande n'existe pour aucun des deux.",
  ...
  nl: {
    ...
    "ryc.tab.mine": "Mijn beoordelingen",
    "ryc.mine.back": "terug naar de cursussen",
    "ryc.mine.back.list": "terug naar mijn beoordelingen",
    "ryc.mine.title": "Mijn beoordelingen",
    "ryc.mine.anonymous": "Wat u anoniem publiceerde staat hier niet, en kan hier niet staan: niets verbindt die beoordelingen met een account, in geen van beide richtingen.",
    "ryc.mine.none": "U hebt nog niets onder uw naam gepubliceerd.",
    "ryc.mine.published": "gepubliceerd op {date}",
    "ryc.mine.edited": "aangepast op {date}",
    "ryc.mine.held": "door moderatie uit beeld gehaald",
    "ryc.mine.more": "{n} beoordelingen meer tonen",
    "ryc.mine.edit": "Aanpassen",
    "ryc.mine.editing": "Uw beoordeling van {course} aanpassen",
    "ryc.mine.saving": "Opslaan…",
    "ryc.mine.err.failed": "De aanpassing kon niet worden opgeslagen.",
    "ryc.tab.browse.hint": "U weet in welk programma u zit: doorloop de vakkenlijst ervan.",
    "ryc.tab.search.hint": "U weet welk vak u zoekt: vind het via de code of de titel, in al uw catalogi.",
    "ryc.search.start": "Typ een code, of een woord uit de titel. Bijvoorbeeld:",
    ...
    "ryc.filter.any": "{n} om uit te kiezen",
    "ryc.filter.narrow": "lijst filteren",
    "ryc.filter.noOption": "Niets komt overeen.",
    "ryc.scope.all": "Alle universiteiten",
    "ryc.scope.change": "wijzigen",
    "ryc.scope.done": "klaar",
    "ryc.scope.hint": "Wat u hier houdt, is wat u ziet, ook de volgende keer.",
    ...
    "ryc.browse.more": "{n} opleidingen meer tonen",
    "ryc.filter.show": "Filteren",
    "ryc.filter.show.active": "Filters toegepast",
    "ryc.filter.count": "{shown} van {total} cursussen",
    "ryc.filter.count.window": "{shown} cursussen getoond, van {total} gevonden",
    "ryc.filter.more": "{n} cursussen meer tonen",
    ...
    "ryc.course.objectives": "Leerresultaten",
    "ryc.course.prerequisites": "Vereiste voorkennis",
    "ryc.course.teachingMethods": "Onderwijsmethoden",
    "ryc.course.bibliography": "Bibliografie",
    "ryc.course.noOfficialPage": "Geen bekende officiële pagina.",
    "ryc.course.sourceLanguage": "Fiche door {name} in het Frans gepubliceerd.",
    ...
    "ryc.fork.named.4": "U kunt ze aanpassen en terugvinden bij \u00ab Mijn beoordelingen \u00bb.",
    ...
    "ryc.fork.note":
      "Aanpassen zal nooit gelden voor een anonieme beoordeling: niemand, wij inbegrepen, kan terugvinden welke de uwe is. Verwijderen op verzoek bestaat voor geen van beide.",
  ...
  en: {
    ...
    "ryc.tab.mine": "My reviews",
    "ryc.mine.back": "back to the courses",
    "ryc.mine.back.list": "back to my reviews",
    "ryc.mine.title": "My reviews",
    "ryc.mine.anonymous": "What you published anonymously is not here, and cannot be: nothing links those reviews to an account, in either direction.",
    "ryc.mine.none": "You have not published anything under your name yet.",
    "ryc.mine.published": "published {date}",
    "ryc.mine.edited": "edited {date}",
    "ryc.mine.held": "taken out of view by moderation",
    "ryc.mine.more": "Show {n} more reviews",
    "ryc.mine.edit": "Edit",
    "ryc.mine.editing": "Edit your review of {course}",
    "ryc.mine.saving": "Saving…",
    "ryc.mine.err.failed": "The change could not be saved.",
    "ryc.tab.browse.hint": "You know which programme you are in: walk through its course list.",
    "ryc.tab.search.hint": "You know which course you want: find it by code or title, across every catalogue you follow.",
    "ryc.search.start": "Type a code, or a word from the title. For example:",
    ...
    "ryc.filter.any": "{n} to choose from",
    "ryc.filter.narrow": "narrow this list",
    "ryc.filter.noOption": "Nothing matches.",
    "ryc.scope.all": "All universities",
    "ryc.scope.change": "change",
    "ryc.scope.done": "done",
    "ryc.scope.hint": "What you keep here is what you see, next time too.",
    ...
    "ryc.browse.more": "Show {n} more programmes",
    "ryc.filter.show": "Filter",
    "ryc.filter.show.active": "Filters applied",
    "ryc.filter.count": "{shown} of {total} courses",
    "ryc.filter.count.window": "{shown} courses shown, of {total} found",
    "ryc.filter.more": "Show {n} more courses",
    ...
    "ryc.course.objectives": "Learning outcomes",
    "ryc.course.prerequisites": "Prerequisites",
    "ryc.course.teachingMethods": "Teaching methods",
    "ryc.course.bibliography": "Bibliography",
    "ryc.course.noOfficialPage": "No official page known.",
    "ryc.course.sourceLanguage": "Course record published by {name} in French.",
    ...
    "ryc.fork.named.4": "You can edit it, and find it again under \u201cMy reviews\u201d.",
    ...
    "ryc.fork.note":
      "Editing will never apply to an anonymous review: nobody, us included, can find out which is yours. Deletion on request exists for neither.",
