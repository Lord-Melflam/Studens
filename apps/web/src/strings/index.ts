...
export const shellStrings: Bundle = {
  fr: {
    ...
    "theme.to.dark": "Passer en sombre",
    "theme.to.light": "Passer en clair",
    "settings.theme.hint": "Vaut pour cet appareil, et pour cet appareil seulement. Rien n'en est envoyé nulle part.",
    ...
    "settings.sessions.alike": "Les autres se ressemblent toutes, et c'est voulu : une connexion n'enregistre que sa date. Si l'une d'elles vous inquiète, fermez-les toutes sauf celle-ci.",
    "settings.sessions.more": "Voir les {n} autres",
    "settings.sessions.endothers": "Fermer les {n} autres connexions",
    "app.setup.prompt": "Votre configuration n'est pas terminée : vous n'avez pas encore de pseudonyme.",
    "app.setup.resume": "Votre configuration n'est pas terminée. Rien ne change tant que vous ne l'avez pas finie.",
    ...
    "signin.title": "Entrer",
    "suspended.title": "Votre compte est suspendu",
    "suspended.lede": "Ce n'est pas une panne. L'accès a été retiré à ce compte par une décision de modération, et voici ce qui la motive.",
    "suspended.reason": "Motif",
    "suspended.until": "Jusqu'au",
    "suspended.until.permanent": "Sans date de fin.",
    "suspended.contact": "Pour en discuter",
    "suspended.published": "Ce que vous avez publié anonymement n'est pas concerné : rien ne relie ces contributions à un compte, dans un sens comme dans l'autre. Un contenu précis peut être retiré séparément, sur ses propres mérites.",
    "suspended.none.title": "Rien à afficher ici",
    "suspended.none.body": "Cette page explique une suspension à la personne concernée, juste après sa connexion. Vous n'avez rien à y lire.",
    "suspended.none.signin": "Se connecter",
    "signin.lede":
    ...
    "mod.settings.hint": "Ce que vous changez ici s'applique tout de suite, pour tout le monde. Chaque changement est inscrit au journal. La clé nomme le module qui la lit.",
    "mod.settings.range": "entre {min} et {max}, {fallback} par défaut",
    "mod.settings.save": "Enregistrer",
    "mod.settings.saved": "Enregistré.",
    "mod.settings.refused": "Valeur refusée : elle est hors des bornes indiquées.",
    "mod.suspend": "Suspendre un compte",
    "mod.suspend.account": "Cela suspend un COMPTE, pas une personne. L'inscription est ouverte, donc la même personne peut en créer un autre : c'est un ralentisseur, rien de plus.",
    "mod.suspend.anonymous": "Cela n'atteint pas ce qui a été publié anonymement : rien ne relie ces contributions à un compte, et elles ne peuvent être ni retrouvées ni retirées en bloc. Un contenu précis reste supprimable, un par un.",
    "mod.suspend.username": "Pseudonyme",
    "mod.suspend.length": "Durée",
    "mod.suspend.days": "{n} jours",
    "mod.suspend.permanent": "définitive",
    "mod.suspend.reason": "Motif",
    "mod.suspend.do": "Suspendre",
    "mod.suspend.lift": "Lever la suspension",
    "mod.suspend.done": "C'est fait. Les sessions ouvertes ont été fermées.",
    "mod.suspend.refused": "Refusé : on ne suspend ni soi-même, ni un administrateur.",
    "mod.suspend.failed": "Échec : ce pseudonyme n'existe pas, ou le motif manque.",
    "mod.suspend.done.unmailed": "C'est fait. Les sessions ouvertes ont été fermées. Aucun message n'a pu partir : ce compte n'a pas d'adresse confirmée, la personne l'apprendra à sa prochaine connexion.",
    "mod.section.signalements": "Signalements",
    "mod.section.comptes": "Comptes",
    "mod.section.roles": "Rôles",
    "mod.section.reglages": "Réglages",
    "mod.suspended": "Comptes suspendus",
    "mod.suspended.find": "Chercher un pseudonyme",
    "mod.suspended.none": "Aucun compte suspendu.",
    "mod.suspended.nomatch": "Aucun compte suspendu sous ce nom.",
    "mod.suspended.permanent": "sans date de fin",
    "mod.suspended.until": "jusqu'au {date}",
    "mod.suspended.unmailed": "non prévenu",
    "mod.suspended.since": "depuis le {date}",
    "mod.suspended.by": "décidé par {who}",
    "mod.page.prev": "Précédents",
    "mod.page.next": "Suivants",
    "mod.page.where": "Page {page} sur {pages}",
  ...
  nl: {
    ...
    "theme.to.dark": "Naar donker",
    "theme.to.light": "Naar licht",
    "settings.theme.hint": "Geldt voor dit toestel, en alleen voor dit toestel. Er wordt niets van verstuurd.",
    "settings.theme.system": "Zoals het toestel",
    ...
    "settings.sessions.alike": "De andere lijken allemaal op elkaar, en dat is bewust: een aanmelding bewaart alleen haar datum. Baart er een u zorgen, sluit dan alle andere.",
    "settings.sessions.more": "De {n} andere tonen",
    "settings.sessions.endothers": "De {n} andere aanmeldingen sluiten",
    "app.setup.prompt": "Uw installatie is niet afgerond: u hebt nog geen gebruikersnaam.",
    "app.setup.resume": "Uw installatie loopt nog. Er verandert niets zolang ze niet afgerond is.",
    ...
    "suspended.title": "Uw account is geschorst",
    "suspended.lede": "Dit is geen storing. De toegang tot dit account is ingetrokken door een moderatiebeslissing, en dit is de reden.",
    "suspended.reason": "Reden",
    "suspended.until": "Tot",
    "suspended.until.permanent": "Zonder einddatum.",
    "suspended.contact": "Om erover te praten",
    "suspended.published": "Wat u anoniem publiceerde valt hier niet onder: niets verbindt die bijdragen met een account, in geen van beide richtingen. Een welbepaalde inhoud kan apart verwijderd worden, op eigen gronden.",
    "suspended.none.title": "Hier valt niets te zien",
    "suspended.none.body": "Deze pagina legt een schorsing uit aan wie het betreft, meteen na het aanmelden. Voor u staat er niets.",
    "suspended.none.signin": "Aanmelden",
    "signin.lede":
    ...
    "mod.title": "Moderatie",
    "mod.settings": "Instellingen",
    "mod.settings.hint": "Wat u hier wijzigt geldt meteen, voor iedereen. Elke wijziging komt in het logboek. De sleutel noemt de module die hem uitleest.",
    "mod.settings.range": "tussen {min} en {max}, standaard {fallback}",
    "mod.settings.save": "Opslaan",
    "mod.settings.saved": "Opgeslagen.",
    "mod.settings.refused": "Waarde geweigerd: ze valt buiten de aangegeven grenzen.",
    "mod.suspend": "Een account schorsen",
    "mod.suspend.account": "Dit schorst een ACCOUNT, geen persoon. Registratie staat open, dus dezelfde persoon kan er een nieuw aanmaken: het is een drempel, niet meer.",
    "mod.suspend.anonymous": "Dit raakt niet wat anoniem gepubliceerd is: niets verbindt die bijdragen met een account, en ze kunnen niet als groep teruggevonden of ingetrokken worden. Een welbepaalde inhoud blijft wel verwijderbaar, een voor een.",
    "mod.suspend.username": "Pseudoniem",
    "mod.suspend.length": "Duur",
    "mod.suspend.days": "{n} dagen",
    "mod.suspend.permanent": "definitief",
    "mod.suspend.reason": "Reden",
    "mod.suspend.do": "Schorsen",
    "mod.suspend.lift": "Schorsing opheffen",
    "mod.suspend.done": "Gedaan. De open sessies zijn gesloten.",
    "mod.suspend.refused": "Geweigerd: u schorst noch uzelf, noch een beheerder.",
    "mod.suspend.failed": "Mislukt: dat pseudoniem bestaat niet, of de reden ontbreekt.",
    "mod.suspend.done.unmailed": "Gedaan. De open sessies zijn gesloten. Er kon geen bericht vertrekken: dit account heeft geen bevestigd adres, de persoon verneemt het bij de volgende aanmelding.",
    "mod.section.signalements": "Meldingen",
    "mod.section.comptes": "Accounts",
    "mod.section.roles": "Rollen",
    "mod.section.reglages": "Instellingen",
    "mod.suspended": "Geschorste accounts",
    "mod.suspended.find": "Een pseudoniem zoeken",
    "mod.suspended.none": "Geen enkel geschorst account.",
    "mod.suspended.nomatch": "Geen geschorst account onder die naam.",
    "mod.suspended.permanent": "zonder einddatum",
    "mod.suspended.until": "tot {date}",
    "mod.suspended.unmailed": "niet verwittigd",
    "mod.suspended.since": "sinds {date}",
    "mod.suspended.by": "beslist door {who}",
    "mod.page.prev": "Vorige",
    "mod.page.next": "Volgende",
    "mod.page.where": "Pagina {page} van {pages}",
  ...
  en: {
    ...
    "theme.to.dark": "Switch to dark",
    "theme.to.light": "Switch to light",
    "settings.theme.hint": "Applies to this device, and only this device. None of it is sent anywhere.",
    "settings.theme.system": "Match the device",
    ...
    "settings.sessions.alike": "The others all look alike, and that is on purpose: a sign-in records only its date. If one of them worries you, end every one but this.",
    "settings.sessions.more": "Show the {n} others",
    "settings.sessions.endothers": "End the {n} other sign-ins",
    "app.setup.prompt": "Your setup is not finished: you have no username yet.",
    "app.setup.resume": "Your setup is in progress. Nothing has changed until you finish it.",
    "app.setup.go": "Resume",
    ...
    "suspended.lede": "This is not an outage. Access was withdrawn from this account by a moderation decision, and here is what it was for.",
    "suspended.reason": "Reason",
    "suspended.until": "Until",
    "suspended.until.permanent": "With no end date.",
    "suspended.contact": "To discuss it",
    "suspended.published": "What you published anonymously is not affected: nothing links those contributions to an account, in either direction. A particular piece of content can be removed separately, on its own merits.",
    "suspended.none.title": "Nothing to show here",
    "suspended.none.body": "This page explains a suspension to the person it concerns, just after they sign in. There is nothing here for you.",
    "suspended.none.signin": "Sign in",
    "signin.lede":
    ...
    "mod.settings.hint": "What you change here applies at once, for everybody. Every change is written to the log. The key names the module that reads it.",
    "mod.settings.range": "between {min} and {max}, {fallback} by default",
    "mod.settings.save": "Save",
    "mod.settings.saved": "Saved.",
    "mod.settings.refused": "Value refused: it is outside the stated bounds.",
    "mod.suspend": "Suspend an account",
    "mod.suspend.account": "This suspends an ACCOUNT, not a person. Registration is open, so the same person can make another one: it is a speed bump and nothing more.",
    "mod.suspend.anonymous": "It does not reach what was published anonymously: nothing links those contributions to an account, and they cannot be found or withdrawn as a set. A particular piece of content is still removable, one at a time.",
    "mod.suspend.username": "Username",
    "mod.suspend.length": "Length",
    "mod.suspend.days": "{n} days",
    "mod.suspend.permanent": "permanent",
    "mod.suspend.reason": "Reason",
    "mod.suspend.do": "Suspend",
    "mod.suspend.lift": "Lift the suspension",
    "mod.suspend.done": "Done. Open sessions were closed.",
    "mod.suspend.refused": "Refused: you suspend neither yourself nor an administrator.",
    "mod.suspend.failed": "Failed: that username does not exist, or the reason is missing.",
    "mod.suspend.done.unmailed": "Done. Open sessions were closed. No message could go out: this account has no confirmed address, so the person will learn of it at their next sign-in.",
    "mod.section.signalements": "Reports",
    "mod.section.comptes": "Accounts",
    "mod.section.roles": "Roles",
    "mod.section.reglages": "Settings",
    "mod.suspended": "Suspended accounts",
    "mod.suspended.find": "Find a username",
    "mod.suspended.none": "No account is suspended.",
    "mod.suspended.nomatch": "No suspended account under that name.",
    "mod.suspended.permanent": "no end date",
    "mod.suspended.until": "until {date}",
    "mod.suspended.unmailed": "not notified",
    "mod.suspended.since": "since {date}",
    "mod.suspended.by": "decided by {who}",
    "mod.page.prev": "Previous",
    "mod.page.next": "Next",
    "mod.page.where": "Page {page} of {pages}",
