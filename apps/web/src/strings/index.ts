...
export const shellStrings: Bundle = {
  fr: {
    ...
    "mod.counts": "{open} signalements, dont {members} depuis un compte",
  ...
  nl: {
    ...
    "mod.counts": "{open} meldingen, waarvan {members} vanaf een account",
  ...
  en: {
    ...
    "mod.counts": "{open} reports, {members} of them from an account",
